...
jetcobot_interfaces__action__OrderJetcobot_Goal__init(jetcobot_interfaces__action__OrderJetcobot_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->order)) {
    jetcobot_interfaces__action__OrderJetcobot_Goal__fini(msg);
    return false;
  }
  return true;
}
...
jetcobot_interfaces__action__OrderJetcobot_Goal__create(void)
{
  ...
  jetcobot_interfaces__action__OrderJetcobot_Goal * msg = (jetcobot_interfaces__action__OrderJetcobot_Goal *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_Goal));
  bool success = jetcobot_interfaces__action__OrderJetcobot_Goal__init(msg);
  if (!success) {
...
jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Goal * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_Goal *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_Goal__fini(&data[i - 1]);
      }
...
jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence__init(array, size);
  if (!success) {
...
jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_Goal * data =
      (jetcobot_interfaces__action__OrderJetcobot_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_Goal__copy(
...
jetcobot_interfaces__action__OrderJetcobot_Result__init(jetcobot_interfaces__action__OrderJetcobot_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->status)) {
    jetcobot_interfaces__action__OrderJetcobot_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Result * msg = (jetcobot_interfaces__action__OrderJetcobot_Result *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_Result));
  bool success = jetcobot_interfaces__action__OrderJetcobot_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_Result__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Result * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_Result *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_Result__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_Result__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_Result__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_Result__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_Result * data =
      (jetcobot_interfaces__action__OrderJetcobot_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Feedback * msg = (jetcobot_interfaces__action__OrderJetcobot_Feedback *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_Feedback));
  bool success = jetcobot_interfaces__action__OrderJetcobot_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_Feedback__destroy(jetcobot_interfaces__action__OrderJetcobot_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    jetcobot_interfaces__action__OrderJetcobot_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Feedback * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_Feedback *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_Feedback * data =
      (jetcobot_interfaces__action__OrderJetcobot_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__init(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!jetcobot_interfaces__action__OrderJetcobot_Goal__init(&msg->goal)) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__fini(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * msg)
{
  ...
  // goal
  jetcobot_interfaces__action__OrderJetcobot_Goal__fini(&msg->goal);
}
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__are_equal(const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * lhs, const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!jetcobot_interfaces__action__OrderJetcobot_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * msg = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request));
  bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request * data =
      (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__init(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response * msg = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response));
  bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response * data =
      (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__init(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * msg)
{
  ...
  // request
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__fini(&msg->response);
}
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__are_equal(const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * lhs, const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * rhs)
{
  ...
  // request
  if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__are_equal(
  ...
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * output)
{
  ...
  // request
  if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * msg = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event));
  bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event * data =
      (jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__init(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Request * msg = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Request *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request));
  bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Request * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Request *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Request * data =
      (jetcobot_interfaces__action__OrderJetcobot_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__init(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!jetcobot_interfaces__action__OrderJetcobot_Result__init(&msg->result)) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__fini(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * msg)
{
  ...
  // status
  // result
  jetcobot_interfaces__action__OrderJetcobot_Result__fini(&msg->result);
}
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__are_equal(const jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * lhs, const jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * rhs)
{
  ...
  // result
  if (!jetcobot_interfaces__action__OrderJetcobot_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * msg = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Response *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response));
  bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Response *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Response * data =
      (jetcobot_interfaces__action__OrderJetcobot_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__init(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__init(&msg->request, 0)) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__init(&msg->response, 0)) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__fini(&msg->request);
  // response
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__fini(&msg->response);
}
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__are_equal(const jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * lhs, const jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * rhs)
{
  ...
  // request
  if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * output)
{
  ...
  // request
  if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * msg = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Event *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event));
  bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Event *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_GetResult_Event * data =
      (jetcobot_interfaces__action__OrderJetcobot_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__init(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!jetcobot_interfaces__action__OrderJetcobot_Feedback__init(&msg->feedback)) {
    jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__fini(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  jetcobot_interfaces__action__OrderJetcobot_Feedback__fini(&msg->feedback);
}
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__are_equal(const jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * lhs, const jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!jetcobot_interfaces__action__OrderJetcobot_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * msg = (jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage));
  bool success = jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence__init(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * data = NULL;

  if (size) {
    data = (jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage *)allocator.zero_allocate(size, sizeof(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence__fini(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * array = (jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence *)allocator.allocate(sizeof(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence__destroy(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence__are_equal(const jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * lhs, const jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage * data =
      (jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!jetcobot_interfaces__action__OrderJetcobot_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
