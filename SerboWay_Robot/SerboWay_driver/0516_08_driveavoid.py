...
class DriveNode(Node):
    def __init__(self):
        ...
        self.side_detect_thresh = 0.30  # m 측면 장애물 감지 기준
        self.drive_obs_time     = 0.3   # s 첫 회피 전진 시간
        self.surf_drive_time    = 0.1  # s 두 번째 회전 후 전진 시간
        self.too_close_thresh   = 0.10  # m 측면 장애물 너무 가까이 붙었을 때 기준
    ...
    def control_loop(self):
        ...
        if self.state == 'SURFACE_DRIVE':
            ...
            if side < self.too_close_thresh:
                ...
                self.adj_heading0 = math.atan2(self.wy_f - self.wy_r, self.wx_f - self.wx_r)
