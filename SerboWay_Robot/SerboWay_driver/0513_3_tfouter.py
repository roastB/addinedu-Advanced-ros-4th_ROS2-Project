...
# 호모그래피 기준: 마커 중심이 아니라 마커 외곽(맵 꼭짓점)을 가리키도록 보정
marker_world = {
    0: (0   + half,  0   + half),   # 왼쪽 아래 외곽
    1: (MAP_WIDTH_CM - half,  0   + half),   # 오른쪽 아래 외곽
    3: (0   + half,  MAP_HEIGHT_CM - half),  # 왼쪽 위 외곽
    4: (MAP_WIDTH_CM - half,  MAP_HEIGHT_CM - half),  # 오른쪽 위 외곽
}
